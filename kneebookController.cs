...
public class kneebookController : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        entries.Add("ASTEROID CLASSIFICATIONS:\n\nA-TYPE: METALLIC\nB-TYPE: SOFTER METALLIC\nG-TYPE: GAS\nC-TYPE: CARBONIC\nU-TYPE: UNKNOWN"); //Page 14

        entries.Add("STEP-BY-STEP MINING PROCEDURE:\n\n1. LOCK AN ASTEROID\n2. ANALYZE ASTEROID\n3. NOTE ORE COMPOSITION AND ADJUST LASER AS NEEDED\nHOLD LEFT CLICK TO FIRE LASER AND TRACTOR BEAM."); // Page 15

        entries.Add("LASER INTENSITY:\n\nSCROLL TO ADJUST.\n HIGH INTENSITY = HIGHER YIELD.\nLOW INTENSITY = HIGHER STABILITY"); // Page 16

        entries.Add("INTENSITY WARNING:\n\nTOO MUCH POWER MAY DESTROY LOW-INTEGRITY ORE BEFORE EXTRACTION."); // Page 17

        entries.Add("ANALYSIS TIP:\n\nSEE 'ORE GUIDE' (PG. 21) FOR INTENSITY RECOMMENDATIONS PER ORE TYPE."); // Page 18

        entries.Add("WEAPON CONTROLS:\n\n(HOLD) LEFT CLICK - FIRE LASER\nSCROLL WHEEL - ADJUST INTENSITY"); // Page 19

        entries.Add("TIP:\n\nLASER DAMAGE UPGRADES ARE ONLY FOR SELF DEFENSE.\nLASER DAMAGE UPGRADES HAVE NO EFFECT ON MINING PROCEDURES"); // Page 20

        entries.Add("ECONOMIC GUIDE:\n\nTHE SHERGEO COMPANY RETAINS THE RIGHT TO DEDUCT:\n- UP TO 95% OF CARGO VALUE\n\nAND\n\n- UP TO AN ADDITIONAL $50,000 IN DAILY FEES"); // Page 21

        entries.Add("ORE GUIDE\n\nWRITTEN BY THE SHERGEO COMPANY."); // Page 22

        entries.Add("IRON\n\nINTENSITY: 20–55%\nVALUE: MID\nDENSITY: HIGH"); // Page 23
